...
public class SharedDbCodeValueAdapter implements CodeValuePort {
    ...
    @Override
    public CodeValue findById(Long codeValueId) {
        return codeValueRepositoryWrapper.findOneWithNotFoundDetection(codeValueId);
    }

    @Override
    public CodeValue findByCodeNameAndId(String codeName, Long codeValueId) {
